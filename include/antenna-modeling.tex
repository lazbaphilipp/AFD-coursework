\chapter{Приложение 1: Моделирование излучателя}
...
По графику видно, что отклонение главного луча составило $5^\circ$ и ширина луча по оХ и оУ равна соответственно $40^\circ$ и $32^\circ$, что соотносится с требованием $\theta_\text{ск}= \pm18^\circ$ из ТЗ.